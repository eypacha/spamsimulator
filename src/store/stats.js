...
export const useStatsStore = defineStore('stats', () => {
  ...
  function saveAllStats() {
    saveStats({
      ...
      totalScore: statsTracker.totalScore.value,
  ...
  return {
    ...
    totalNigerianPrinceDeleted,
    totalCoinsEarned,
    totalVirusesInfected: computed(() => statsTracker.totalVirusesInfected.value),
    totalAppointmentsConfirmed: computed(() => statsTracker.totalAppointmentsConfirmed.value),
    recordAppointmentConfirmed: statsTracker.recordAppointmentConfirmed,
    playedAt6AM: computed(() => statsTracker.playedAt6AM.value),
    playedAt3AM: computed(() => statsTracker.playedAt3AM.value),
    totalPlayTimeMinutes: computed(() => statsTracker.totalPlayTimeMinutes.value),
    currentStreak,
    maxStreak,
    catPicturesViewed: computed(() => statsTracker.catPicturesViewed.value),
    markCatPictureViewed: statsTracker.markCatPictureViewed,
    upgradeCost,
    trashUpgradeCost,
    inboxUpgradeCost,
    selectionUpgradeCost,
    maxTrash,
    maxInbox,
    maxSelectable,
    addScore,
    ...
    antivirusUpgradeCost,
    antivirusCooldown,
    activateAntivirus: () => activateAntivirus(removeOneVirus),
    buyAntivirusUpgrade,
    antivirusLevel: abilitiesManager.antivirusLevel,
    // Group Select Upgrade
    groupSelectUnlocked,
    groupSelectUpgradeCost,
    buyGroupSelectUpgrade,
    // Keyboard Shortcuts Upgrade
    keyboardShortcutsUnlocked,
    keyboardShortcutsUpgradeCost,
    buyKeyboardShortcutsUpgrade,
    // Bulk Delete Upgrade
    bulkDeleteUnlocked,
    bulkDeleteUpgradeCost,
    buyBulkDeleteUpgrade,
    // Bulk Archive Upgrade
    bulkArchiveUnlocked,
    bulkArchiveUpgradeCost,
    buyBulkArchiveUpgrade,
    // MobileFriendly Upgrade
    mobileFriendlyUnlocked,
    mobileFriendlyUpgradeCost,
    buyMobileFriendlyUpgrade,
    // Virus by screen
    virusByScreen,
    activeScreens,
    removeOneVirus,
